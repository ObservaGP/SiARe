# 🧭 STATUSPROJ  
### Sistema de Visualização e Modificação de Status de Projetos — **Versão 2.0 (2025)**

<p align="center">
  <img src="https://img.shields.io/badge/HTML-JavaScript-yellow?logo=javascript&logoColor=white&style=flat-square"/>
  <img src="https://img.shields.io/badge/Versão-2.0-blue?style=flat-square"/>
  <a href="https://creativecommons.org/licenses/by-nc/4.0/">
    <img src="https://img.shields.io/badge/Licença-CC%20BY--NC%204.0-lightgrey?style=flat-square"/>
  </a>
...
| `LICENSE` | Termos da licença CC BY-NC 4.0 |
...
> 🌐 **Execução online:**  
> O sistema está hospedado no GitHub Pages e pode ser acessado em  
...
- Criação das páginas:
  ...
  - Compras  
- Criação de exportação CSV  
- Criação de exportação de texto para Convênio/Aditivo  
...
> *StatusProj – Sistema de Visualização e Modificação de Status de Projetos (Versão 2.0)* [Código-fonte].  
> ObservaGP / IFES / UFES.  
> [https://observagp.github.io/statusproj](https://observagp.github.io/statusproj)
...
É permitido o uso e modificação **somente para fins não comerciais**, desde que os autores sejam citados.
